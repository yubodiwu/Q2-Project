...
router.get(`/:id`, function(req, res) {
    ...
    knex.queryBuilder()
        .select('u1.id as user_id','u1.first_name as user_firstname','u1.pic_url','u1.last_name as user_lastname','c.id as connection_id','c.first_name as connection_firstname','c.last_name as connection_lastname')
        .from('users as u1')
